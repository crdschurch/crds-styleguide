...
import { a as process, b as nextTick, c as axios } from './chunk-fa835f3e.js';
import { a as Utils, b as Logger, c as Config } from './chunk-37c15be2.js';
...
class ProfileMenu {
    ...
    envUrl(path) {
        return `${"https://int.crossroads.net"}${path}`;
    }
    handleClick(event) {
        event.stopPropagation();
    }
